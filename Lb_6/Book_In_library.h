...
public:
	Book_In_library();
	//Book_In_library(Book book) : Book(book) {};
	...
	Book_In_library(int n, bool a, char* N, double c, Book book, int s_n = 20);
...
public:
	...
	friend bool operator<(Book_In_library&, Book_In_library&);

	//friend ostream& operator<<(ostream& out, Book_In_library);
